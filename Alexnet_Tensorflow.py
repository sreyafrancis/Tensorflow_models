...
# Description: This .py file has Alexnet implementation in tensorflow.
...
class AlexNet(object):
    ...
    def create(self):
        ...
        pool1 = max_pool(conv1, 3, 3, 1, 1, padding = 'SAME', name = 'pool1')
        ...
        reshape_shape = np.prod(pool5.get_shape().as_list()[1:])

        # 6th Layer: Flatten -> FC (w ReLu) -> Dropout
        flattened = tf.reshape(pool5, [-1, reshape_shape])
